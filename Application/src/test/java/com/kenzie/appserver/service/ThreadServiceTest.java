...
public class ThreadServiceTest {
     ...
     *  ------------------------------------------------------------------------ **/
    //added this test to ensure message is saved to the repo
    @Test
    ...
    //added this test to ensure User table is updated
    @Test
    ...
    //added this test to ensure error is thrown with invalid list size
    @Test
    ...
    //added this test to ensure duplicate threads are not possible
    @Test
    ...
    //added this test to ensure exception thrown with invalid thread
    @Test
